 ...
 * @author user
 */
public class SpinnerFrame extends javax.swing.JFrame {

    /**
     * Creates new form SpinnerFrame
     */
    public SpinnerFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Selected Value");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpinnerFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
